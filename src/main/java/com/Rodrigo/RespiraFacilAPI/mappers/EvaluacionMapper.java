...
public class EvaluacionMapper {
    ...
    public static ResponseEvaluacionDTO toResponseEvaluacionDTO(Evaluacion evaluacion1) {
        ResponseEvaluacionDTO responseEvaluacionDTO= new ResponseEvaluacionDTO(evaluacion1.getIdEvaluaciones(),
                evaluacion1.getFecha(), evaluacion1.getHora(), evaluacion1.getTiempoprediccion(), evaluacion1.getResultado(), evaluacion1.getUsuario().getIdUsuario());
